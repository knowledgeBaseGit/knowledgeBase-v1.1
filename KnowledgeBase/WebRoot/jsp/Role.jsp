...
<script type="text/javascript" src="../js/roleOperate.js"></script>
<script type="text/javascript" src="../js/roleAutho.js"></script>
</head>
<body>
	<div class="all">
		...
		<div class="right">
			<div class="righttop">
				...
				<div class="righttop-right">
					<ul>
						<li id="roleadd"><a href="#" onClick="msgBox('div1', '新增');">新增</a></li>
						<li id="roleUpdate"><a href="#" onClick="beforeupdate();">修改</a></li>
						<li id="roledel"><a href="#" onclick="userdelete();">删除</a></li>
						<li id="roleGrant"><a href="#" onclick="grantPower(1);">授权</a></li>
					</ul>
				</div>
			</div>
