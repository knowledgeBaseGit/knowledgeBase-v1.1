...
<title>无标题文档</title>
<link href="../resource/css/CheckQuery.css" rel="stylesheet"
	type="text/css" />
...
<script type="text/javascript" src="../js/quesCheck.js"></script>
<script type="text/javascript" src="../js/queryCheckAutho.js"></script>
...
<body>
		...
		<div class="righttop">
			<div class="righttop-left">
				关键词： <input type="text" id="selectKeys" class="inputText" /> <input
					type="button" id="search" onclick="search();" value="搜索"
					class="inputbutton" />
			</div>
			<div class="righttop-right">
				<ul>
					<li id="seeQuesChecked"><a href="#" onClick="getChecked();">查看已审核</a></li>
					<li id="seeQuesUnCheck"><a href="#" onClick="getUnCheck();">查看未审核</a></li>
					<li id="checkQues"><a href="#" onClick="checkQues();">审核通过</a></li>
					<li id="qUncheck"><a href="#" onClick="undoCheckQues();">取消审核</a></li>
				</ul>
			</div>
		</div>
	...
	<div id="div1" style="display: none; width: 300px">
		<table class="tab2" id="tab2">
			...
			<tr>
				<td colspan="4"><input type="button" value="确 定" /> <input
					type="button" value="取 消" onClick="msgBox_close();" /></td>
			</tr>
		</table>
	</div>
	...
	<!--弹出层 新版本-->
	<div id="seeQues" style="display: none; width: 540px; height: 210px">
		<div id="tag">
			<div id="Tab0">
				<ul class="menu0" id="menu0">
					<li class="hover" onClick="setTab(0,0)">问题描述</li>
					...
					<li>
						<table class="poptab">
							...
							<tr>
								...
								<td colspan="3"><input type="text" style="width: 417px"
          ...
          <table class="poptab">
            ...
            <tr>
              ...
              <td colspan="3"><textarea style="width:417px; height:70px;" name="soluContent"></textarea></td>
				...
				<div style="height: 140px; margin-top: -180px; overflow: auto">
					<ul id="annex">
						<!-- <li>
           <table class="poptab">
             <tr>
	...
	<div id="addQues" style="display: none; width: 540px; height: 210px">
		<table width="100%">
			<tr>
				<td align="right">问题名称：</td>
				<td><input type="text" name="questionTitle" /></td>
			...
			<tr>
				<td colspan="4" align="center"><input type="button"
					onclick="sure_addQues();" value="提交" /> <input type="button"
					value="取 消" onClick="msgBox_close();" /></td>
			</tr>
			<!--<tr>
	...
	<div id="replyQues" style="display: none; width: 540px; height: 210px">

		<table width="100%">
			<tr>

				<td align="right">问题名称：</td>
				<td><input type="text" readonly="readonly" name="questionTitle" />
					<input type="hidden" id="reply_Id" /></td>
				<td align="right">方案名称：</td>
				<td><input type="text" name="soluName" /></td>
			</tr>
			...
			<tr>
				<td align="right">方案内容：</td>
				<td colspan="3"><textarea rows="5" cols="49" name="soluContent"></textarea></td>
			</tr>
			<tr>
				<td>是否上传附件：</td>
				<td><input type="radio" name="upAnnex" value="0"
					onclick="chooseAnnex();" />是&nbsp;&nbsp; <input type="radio"
					name="upAnnex" value="1" onclick="chooseAnnex();" />否</td>
			</tr>
			<tr id="showUpAnnex" style="display: none;">
				<td align="right">附件名称：</td>
				<td align="right"><input type="text" name="annexName">
				</td>
			...
			<tr>
				<td colspan="4" align="center"><input type="button"
					onclick="sure_replyQues();" value="提交" /> <input type="button"
					value="取 消" onClick="msgBox_close();" /></td>
			</tr>
			<!--<tr>
      <td colspan="2" align="center"><input type="button" class="inputbutton" value="确定"/></td>
